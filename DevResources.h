...
public:
    ...
    HRESULT CreateBuffer(UINT byteWidth, UINT bindFlags, ID3D11Buffer** ppBuffer);
    HRESULT CreateBuffer(const void* pSysMem, UINT byteWidth, UINT bindFlags, ID3D11Buffer** ppBuffer);
    ...
    HRESULT CreateShaderResourceView(ID3D11Resource* pResource, DXGI_FORMAT format,
    ...
    HRESULT LoadTextureFromResource(HINSTANCE hInstance, INT nResourceID,
                                    ID3D11Resource** ppTexture, ID3D11ShaderResourceView** ppTextureView);
